  ...
  return (
    <div className="min-h-screen flex overflow-hidden">
      ...
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(ellipse 80% 60% at 0% 50%, rgba(99,102,241,0.15) 0%, transparent 70%), radial-gradient(ellipse 60% 80% at 100% 100%, rgba(16,185,129,0.08) 0%, transparent 70%)",
        }}
      >
        <div
        ...
        <div
          className="absolute bottom-10 right-0 w-64 h-64 rounded-full bg-emerald-500/8 blur-[80px] animate-pulse"
        ...
        <div className="relative z-10 grid grid-cols-3 gap-4">
          {[
            ...
            <div
              key={f.label}
              className="px-4 py-3 rounded-xl border border-white/[0.06] bg-white/[0.02] backdrop-blur"
            >
        ...
        >
          ...
          <div className="mb-8">
            ...
            <p className="text-white/40 text-sm">
              Inicia sesión para continuar tu flujo
            </p>
          </div>
